...
Message_Integer = [ord(char) for char in Message_Text]
# Message_Integer = 17
...
if Diffie_Hellman_Object.Problem == "No Problem":
    ...
    Cipher_2 = []
    for i in Message_Integer:
        Cipher_2.append(Diffie_Hellman_Object.Generate_Cipher_2(Q, K, i))
    ...
    print(f"Cipher_2 sent: {Cipher_2}")
    Response = Client_Socket.recv(1024).decode('utf-8')
    print(Response)
else:
