...
if Diffie_Hellman_Object.Problem == "No Problem":
    ...
    Cipher_2 = ast.literal_eval(Cipher_2)
    ...
    Message_Integer = []
    for i in Cipher_2:
        Message_Integer.append(Diffie_Hellman_Object.Decrypt_Message(Q, K_Inverse, i))
    print(f"M value: {Message_Integer}")

    Message_Text = ''.join([chr(i) for i in Message_Integer])
