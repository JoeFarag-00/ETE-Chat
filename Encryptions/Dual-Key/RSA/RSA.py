...
class rsa_keygenerator:
    ...
    def calculate_Euler_Totient(self):
    ...
    def e_picker(self):
        ...
        while True:
            ...
            if math.gcd(self.e, self.phyn) == 1:
                break
        return self.e
...
class rsa_enc_and_dec:
    ...
    def encrypt(self, plaintext = ""):
        ...
        #encryption
        ciphertext = pow(numeric_representation, self.other.public[0], self.other.public[1])
        #ciphertext = pow(ciphertext, self.me.private[0], self.me.private[1])
        return ciphertext
    ...
    def decrypt(self, ciphertext):
        ...
        """
        # Perform decryption
        #decrypted_numeric = pow(ciphertext, self.other.public[0], self.other.public[1])
        decrypted_numeric = pow(ciphertext, self.me.private[0], self.me.private[1])
