...
if __name__ == "__main__":
    key = edRC4.generate_key(256)
    print(key)
    
    cipher = edRC4(key, 256)
    ...
    key = edRC4.generate_key(700)
    #print(key)
    cipher = edRC4(key, 700)
    ...
    key = edRC4.generate_key(200)
    #print(key)
    cipher = edRC4(key, 200)
